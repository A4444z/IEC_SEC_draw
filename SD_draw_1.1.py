...
name = "Smurf1-Heparin-20230321" #希望的图片名称
filename = "202303201-SMURF1-heparin-0-50%-50min" #读取的文件名
y0 = -10
y1 = 50
x0 = 60
x1 = 110
filepath = os.path.abspath(os.path.dirname(__file__)) #读取文件路径，不能用os.cwd()
file = filepath +'/'+filename + '.xls' #将路径和文件名组装
